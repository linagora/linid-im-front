...
Create `src/lifecycle.ts` in your business module. We recommend extending `BasicRemoteModule` from corelib:
...
The module and its host configuration are not added to the registries and does not participate in lifecycle phases.
